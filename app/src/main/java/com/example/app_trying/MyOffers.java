...
public class MyOffers extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, TripAdapter.ItemClickListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch(id){
            case R.id.My_Profile:
                Intent Navig = new Intent(MyOffers.this, Profile.class);
                startActivity(Navig);
                break;

            case R.id.Chat:
                Intent Navig1 = new Intent(MyOffers.this, Messages.class);
                startActivity(Navig1);
                break;

            case R.id.Offers:
                Intent Navig2 = new Intent(MyOffers.this, Home.class);
                startActivity(Navig2);
                break;

            case R.id.demands:
                Intent Navig3 = new Intent(MyOffers.this, Demands.class);
                startActivity(Navig3);
                break;

            /*case R.id.MyOffers:
                Intent Navig4 = new Intent(MyOffers.this, MyOffers.class);
                startActivity(Navig4);
                break;*/

            case R.id.MyDemands:
                Intent Navig5 = new Intent(MyOffers.this, MyDemands.class);
                startActivity(Navig5);
                break;

            case R.id.Users:
                Intent Navig6 = new Intent(MyOffers.this, Signaler.class);
