...
public class OfferModification extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final String seatsTripModif = getIntent().getStringExtra("seatsTripModif");
        ...
        getSupportActionBar().setTitle("Modifier Votre Offre");
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final String UserUid = mAuth.getCurrentUser().getUid();
        mReference3 = FirebaseDatabase.getInstance().getReference("Trips").child(idTripModif);
        ...
        mReference3.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                depart.setText(newTrip.getmInitLocat());
                destin.setText(newTrip.getmFinalLocat());
                modifDate.setText(newTrip.getmDate());
                modifTime.setText(newTrip.getmTime());
                modifPrix.setText(newTrip.getmPrice());
                modifPlaces.setText(newTrip.getmSeatsAvail());
                modifComment.setText(newTrip.getmComment());
            }
        ...
        modifM = findViewById(R.id.modifmoinsBtn);
        ModifP = findViewById(R.id.modifplusBtn);
        nbrPlace = Integer.parseInt(seatsTripModif);
        ModifP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                modifPlaces.setText("" + nbrPlace);

            }
        });
        modifM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        enregistrer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                && !modifTime.getText().toString().equals("") && !modifPrix.getText().toString().equals("") && !modifPlaces.getText().toString().equals("0")){

                    Trip finalOne = new Trip(idTripModif,idChauffeurModif,nameChauffeurModif,depart.getText().toString(),destin.getText().toString(),
                            modifDate.getText().toString(),modifTime.getText().toString(),modifPrix.getText().toString(),modifPlaces.getText().toString(),
                            modifComment.getText().toString());

                    mReference3.setValue(finalOne);

                    Intent goToTrip = new Intent(OfferModification.this,Home.class);
    ...
    private void pickADateMethod() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(OfferModification.this,
    ...
    private void setATimeMethod() {
        ...
        mTimePicker = new TimePickerDialog(OfferModification.this,R.style.Theme_MyTheme_TimePicker,new TimePickerDialog.OnTimeSetListener() {
            @Override
