...
public class Recherche extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        annulerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent goToTrips = new Intent(Recherche.this,Home.class);
        ...
        rechercherBtn = findViewById(R.id.rechercheBtn);
            mReference5 = mDatabase.getReference("Trips");
                        ...
                        mReference5.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                                    ...
                                    if (!depart) {
                                        if (!trip.getmInitLocat().equals(DepartBtn.getText().toString())) {
                                            one = false;
                                        }else{
                                            one = true;
                                        }
                                    ...
                                    if (!destin) {
                                        if (!trip.getmFinalLocat().equals(DestinationBtn.getText().toString())) {
                                            two = false;
                                        }else{
                                            two = true;
                                        }
                                    ...
                                    if (!time) {
                                        if (!trip.getmTime().equals(setaTime.getText().toString())) {
                                            three = false;
                                        }else{
                                            three = true;
                                        }
                                    ...
                                    if (!date) {
                                        if (!trip.getmDate().equals(pickaDate.getText().toString())) {
                                            four = false;
                                        }else{
                                            four = true;
                                        }
                                ...
                                Intent goToAhaaah = new Intent(Recherche.this, RechercheResult.class);
                                goToAhaaah.putExtra("myList", mTripList);
    ...
    private void setATimeMethod() {
        ...
        mTimePicker = new TimePickerDialog(Recherche.this,R.style.Theme_MyTheme_TimePicker,new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void pickADateMethod() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(Recherche.this,
